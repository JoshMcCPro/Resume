; no copy (the cp command in Unix/Linux Systems)
...
buffer  resb 100000         ; reserving 100000 bytes to store the contents of a file
...
read_src:
    ...
    mov edx, 1000000 ; max number of bytes to be read goes where?
...
create_dst:
    ...
    mov ecx, 0777o ; set file permissions to 0777o 
